...
routes.get('/users/search', new UserController().findByName)
routes.get('/users/:id', new UserController().findById)
routes.put('/users/:id', new UserController().updateUser)
routes.put('/users/account/:id', new UserController().updateAccount)
...
routes.get('/products/search', new ProductController().findByName)
