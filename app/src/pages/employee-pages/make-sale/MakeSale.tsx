import { useMediaQuery, Box, Grid, TableContainer, Paper, LinearProgress, Typography, Divider, Table, TableHead, TableRow, TableCell, TableBody, Card, CardContent, useTheme } from "@mui/material"
  ...
  useEffect(() => {
    ...
    debounce(() => {
      ...
      .then(result => {
        ...
        setRows(result.filter(product => (product.quantity)! > 0))
      })
    })
  }, [search])
